...
import (
	...
	"touchstone.com/ccip/handson/contracts/generated/mock_v3_aggregator_contract"
)
...
// PrintErr prints if error the given error is non-nil.
func PrintAndPanicErr(msg string, err error) {
	if err != nil {
		fmt.Printf(msg + "\n\t%v\n",err.Error())
		panic(err)
	}
